					...
					<?php global $woocommerce; ?> 
						<ul>
							<?php if ( is_user_logged_in() ) { ?>
								<li>
								<?php if(is_archive('post-type-archive-product') || is_singular('monograph') || is_singular('product') || is_page('2219') || is_page('your-custom-formulas') || is_page('cart') || is_page('checkout') || is_page('my-account')){ 
