<?php 
/*
* Template Name: Edit Compound Page Template
*/
get_header(); 
?>
							...
							// } else {
								...
								if($sizes) {
									...
									foreach($sizes as $sizeprice) {
										...
										$size=$sizeprice[0];
										$price=$sizeprice[1];
										if($compound_id !='' && $compound_sizes[$i]->name !='' && $compound_prices[$i]->name !='' ){
										...
										if($i==0) { 
											...
											if($compound_id !='' && $compound_sizes[0]->name !='' && $compound_prices[0]->name !='' ){
